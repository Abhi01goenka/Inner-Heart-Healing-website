...
export default function AboutUs() {
    return (
        <>
            ...
            <div className="bg-stone-900 flex flex-col items-center justify-center space-y-8 px-4 pb-[2rem]">
                {/* Heading */}
            ...
            <div className="flex bg-stone-900 justify-center items-center h-fit pb-[2rem] flex-col px-4">
                ...
                <p className="text-neutral-400 text-neutral-400 text-xl md:text-3xl max-w-3xl mx-auto mb-10 text-center">
                ...
                <p className="text-neutral-400 text-neutral-400 text-xl md:text-3xl max-w-3xl mx-auto text-center">
            ...
            <div className="flex justify-center items-center h-fit pb-[2rem] flex-col px-4">
                ...
                <p className="text-neutral-400 font-bold text-neutral-400 text-xl md:text-3xl max-w-3xl mx-auto mb-10 text-center">
                ...
                <p className="text-neutral-400 font-bold text-neutral-400 text-xl md:text-3xl max-w-3xl mx-auto text-center">
                ...
                <section className="py-10">
                    <div className="container mx-auto px-4 space-y-12">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:space-x-6">
                            <div className="md:w-1/2 aspect-video md:aspect-[16/9] lg:aspect-[21/9] mb-[1rem]">
