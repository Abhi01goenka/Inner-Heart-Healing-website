                ...
                <div className="bg-neutral-800 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <h1 className="text-3xl font-extrabold text-white mb-4">
                            A Case Study of Senso Neural Hearing Loss healed successfully
                        </h1>

                        {/* Blog Meta */}
                        <div className="flex items-center text-gray-400 text-sm mb-6">
                            <span>Published on: December 11, 2022</span>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        <img
                            src="/blog-11-12-2022.jpeg"
                            alt="A Case Study of Senso Neural Hearing Loss healed successfully"
                    ...
                    <div className="p-6">
                        ...
                        <div className="text-gray-300 leading-8 space-y-6">
                            ...
                            <p>
                                Article link: <br />
                                <a href="http://ijpbms.com/index.php/ijpbms/article/view/203" target="_blank" className="text-blue-500 hover:underline">http://ijpbms.com/index.php/ijpbms/article/view/203</a>
                            </p>
                        </div>
                    </div>
                </div>
