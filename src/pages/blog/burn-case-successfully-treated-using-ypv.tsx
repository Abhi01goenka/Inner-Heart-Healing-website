            ...
            <div className="container mx-auto px-4 w-[90vw]">
                ...
                <div className="bg-neutral-800 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        Burn case successfully treated using YPV
                        </h1>
                    ...
                    <div className="relative">
                        <img
                            src="/blog-17-12-2022-1.jpeg"
                            alt="Burn case successfully treated using YPV"
                    ...
                    <div className="p-6">
                        ...
                        <div className="text-gray-300 leading-8 space-y-6">
                            <p>
                                <a href="https://drive.google.com/file/d/1M-ZYMERPaS4a9FBTaLrIH1beDnHV1CpC/view?usp=share_link" target="_blank" className="text-blue-500 hover:underline">https://drive.google.com/file/d/1M-ZYMERPaS4a9FBTaLrIH1beDnHV1CpC/view?usp=share_link</a>
                            </p>
                        </div>
                    </div>
                </div>
