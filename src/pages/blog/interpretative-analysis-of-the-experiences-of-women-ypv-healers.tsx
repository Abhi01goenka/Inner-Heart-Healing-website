                ...
                <div className="bg-neutral-800 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <h1 className="text-3xl font-extrabold text-white mb-4">
                            Interpretative Analysis of the Experiences of Women YPV Healers
                        </h1>

                        {/* Blog Meta */}
                        <div className="flex items-center text-gray-400 text-sm mb-6">
                            <span>Published on: April 5, 2024</span>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        <img
                            src="/blog-5-04-2024.webp"
                            alt="Interpretative Analysis of the Experiences of Women YPV Healers"
                    ...
                    <div className="p-6">
                        ...
                        <div className="text-gray-300 leading-8 space-y-6">
                            ...
                            <p>
                                Issue link :
                                <a href="https://ijip.in/issue/?volumes=Volume-12-Issue-1" target="_blank" className="text-blue-500 hover:underline">https://ijip.in/issue/?volumes=Volume-12-Issue-1</a>
                            </p>
                        </div>
                    </div>
                </div>
