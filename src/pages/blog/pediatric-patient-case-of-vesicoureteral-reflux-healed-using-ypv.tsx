                ...
                <div className="bg-neutral-800 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <h1 className="text-3xl font-extrabold text-white mb-4">
                            Pediatric patient case of vesicoureteral reflux healed using YPV
                        </h1>
                    ...
                    <div className="relative">
                        <img
                            src="/blog-22-01-2024.webp"
                            alt="Pediatric patient case of vesicoureteral reflux healed using YPV"
                    ...
                    <div className="p-6">
                        ...
                        <div className="text-gray-300 leading-8 space-y-6">
                            <p>
                                Article link :
                                <a href="https://mansapublishers.com/index.php/ijch/article/view/4339" target="_blank" className="text-blue-500 hover:underline">https://mansapublishers.com/index.php/ijch/article/view/4339</a>
                            </p>
                        </div>
                    </div>
                </div>
