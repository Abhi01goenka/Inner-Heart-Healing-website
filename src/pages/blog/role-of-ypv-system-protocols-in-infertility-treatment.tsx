            ...
            <div className="container mx-auto px-4 w-[90vw]">
                ...
                <div className="bg-neutral-800 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        Role of YPV System Protocols in Infertility Treatment
                        </h1>
                    ...
                    <div className="relative">
                        <img
                            src="/blog-13-12-2022.jpeg"
                            alt="Role of YPV System Protocols in Infertility Treatment"
                    ...
                    <div className="p-6">
                        ...
                        <div className="text-gray-300 leading-8 space-y-6">
                            <p>
                                <a href="http://ijpbms.com/index.php/ijpbms/article/view/155" target="_blank" className="text-blue-500 hover:underline">http://ijpbms.com/index.php/ijpbms/article/view/155</a>
                            </p>
                        </div>
                    </div>
                </div>
