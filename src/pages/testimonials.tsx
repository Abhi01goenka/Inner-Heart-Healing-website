    ...
    return (
        <>
            <AuroraBackground>
                ...
                >
                    <div className="min-h-screen flex flex-col items-center justify-center px-4 pb-[2rem]">

                        {/* Heading */}
                        <h1 className="text-4xl font-bold text-white text-center mt-[2rem]">Testimonials</h1>
                    ...
                    <div className="container mx-auto bg-black px-4 space-y-12">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:space-x-6">
                            <div className="w-full md:w-1/2">
                                <img src="/other-testimonial-1.jpeg" alt="Testimonial 1" className="rounded-lg shadow-lg w-full" />
                            </div>
                            <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
                                <h3 className="text-2xl font-bold">Heart Issue</h3>
                                <p className="text-gray-400 text-justify w-[45vw] italic font-bold">
                        ...
                        <div className="flex flex-col md:flex-row-reverse items-center md:space-x-6">
                            <div className="w-full md:w-1/2">
                                <img src="/other-testimonial-2.jpeg" alt="Testimonial 2" className="rounded-lg shadow-lg w-full" />
                            </div>
                            <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
                                <h3 className="text-2xl font-bold">Lumbar Paralysis</h3>
                                <p className="text-gray-400 text-justify pr-[2rem] w-[45vw] italic font-bold">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:space-x-6">
                            <div className="w-full md:w-1/2">
                                <img src="" alt="Testimonial 3" className="rounded-lg shadow-lg w-full h-fit" />
                            </div>
                            <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
